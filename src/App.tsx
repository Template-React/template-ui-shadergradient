...
export default function App() {
  return (
    <>
      ...
      <main className="dark min-h-screen bg-transparent text-foreground flex items-center justify-center px-6">
        <div className="max-w-2xl w-full text-center space-y-8">
          ...
          <p className="text-sm text-muted-foreground pt-6">
            React + Vite + TypeScript + Tailwind + shadcn/ui + shadergradient
          </p>
        </div>
      </main>
    </>
